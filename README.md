...
| 9 | Transmission+VPN | 9091 | Torrent client; **PIA credentials required** |
| 10 | qBittorrent+VPN | 8080 | Torrent client via Gluetun; **any WireGuard VPN provider** — see note below |

### *ARR!
| # | Service | Port | Notes |
|---|---------|------|-------|
| 11 | Prowlarr | 9696 | Indexer manager |
| 12 | Sonarr | 8989 | TV show automation |
| 13 | Radarr | 7878 | Movie automation |
| 14 | Tdarr | 8265 | Media transcoding |
...
| # | Service | Port | Notes |
|---|---------|------|-------|
| 17 | Nextcloud | 8087 | Self-hosted file storage; DB credentials required |
| 18 | oCIS | 9200 | ownCloud Infinite Scale; URL required |
...
| NZBGet, Prowlarr, Sonarr, Radarr | Speedtest, Transmission, qBittorrent+VPN |
...
### Transmission+VPN
Locked to **PIA (Private Internet Access)** via OpenVPN. Requires PIA username, password, and local network CIDR (e.g. `192.168.1.0/24`).
...
├── backend/                 # NZBGet, Transmission, qBittorrent+VPN, Prowlarr, Sonarr, Radarr, Tdarr
